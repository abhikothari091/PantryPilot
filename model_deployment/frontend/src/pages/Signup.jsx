...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-primary-500/20 rounded-full blur-[100px]" />
            <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-emerald-500/20 rounded-full blur-[100px]" />
            ...
            >
                ...
                <p className="text-slate-400 text-center mb-8">Join PantryPilot today</p>
