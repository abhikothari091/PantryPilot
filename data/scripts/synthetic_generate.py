...
output_dir = "/Users/hunjunsin/Desktop/Jun/MLOps/PantryPilot/data/synthetic_data"
os.makedirs(output_dir, exist_ok=True)

inventory_path = os.path.join(output_dir, "pantrypilot_inventory_u20_i60_shared_ids.csv")
purchase_path = os.path.join(output_dir, "pantrypilot_purchase_u20_i60_shared_ids.csv")
