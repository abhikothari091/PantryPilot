...
```
[User Feedback] → [NeonDB: recipe_preferences] → [Cloud Run Job] → [GCS: New Model]
                                                       ↓
...
| `auto_retrain_pipeline.py` | Triggers training job execution |
...
- **Data Backup**: Training data archived for reproducibility
